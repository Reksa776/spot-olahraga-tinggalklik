...
export type OrderPayload = {
     ...
     *
     *   `flow: "DIRECT"`   the buyer settles here. `qrString`/`qrImageUrl` carry the
     *                      gateway's own QRIS data and `number` carries the virtual-account
     *                      or retail-outlet number the gateway issued. None of these is
...
export type PaymentInstructionPayload = {
    ...
    number: string | null;
    /** QRIS payload exactly as the gateway returned it. */
    qrString: string | null;
...
function buildPaymentInstruction(
...
): PaymentInstructionPayload | null {
    ...
    return {
        ...
        number: payment.paymentNumber ?? null,
...
export function buildOrderPayload(
    ...
    return {
        ...
        paymentInstruction: buildPaymentInstruction(latestPayment),
        canPay: payable,
